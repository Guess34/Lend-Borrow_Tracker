...
import net.runelite.client.plugins.lendingtracker.model.PeerReview;
import net.runelite.client.plugins.lendingtracker.model.BorrowRequest;
import net.runelite.client.plugins.lendingtracker.LendingTrackerPlugin.LenderAgreement;
import net.runelite.client.plugins.lendingtracker.services.*;
import net.runelite.client.plugins.lendingtracker.services.group.GroupConfigStore;
import net.runelite.client.plugins.lendingtracker.panel.WebhookConfigDialog;
import net.runelite.client.plugins.lendingtracker.panel.GroupsManagementPanel;
import net.runelite.client.plugins.lendingtracker.panel.SetupPanel;
import net.runelite.client.ui.ColorScheme;
...
public class LendingTrackerPanel extends PluginPanel
{
    ...
    private net.runelite.client.plugins.lendingtracker.LendingTrackerPlugin plugin;
    ...
    public void setPlugin(net.runelite.client.plugins.lendingtracker.LendingTrackerPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private void updateRiskSessionTable() {
        ...
        try {
            if (plugin != null) {
                List<net.runelite.client.plugins.lendingtracker.model.RiskSession> activeSessions = plugin.getActiveRiskSessions();
                
                for (net.runelite.client.plugins.lendingtracker.model.RiskSession session : activeSessions) {
                    if (session.isActive()) {
    ...
    private void updateCollateralTable() {
        ...
        try {
            if (plugin != null) {
                ...
                Collection<net.runelite.client.plugins.lendingtracker.model.CollateralAgreement> agreements = 
                    plugin.getCollateralManager().getAllActiveAgreements();
                
                for (net.runelite.client.plugins.lendingtracker.model.CollateralAgreement agreement : agreements) {
    ...
    private JPanel buildMarketplacePanel()
    {
        ...
        String currentGroupId = groupConfigStore.getCurrentGroupId();
        java.util.List<net.runelite.client.plugins.lendingtracker.model.LendingGroup> allGroups =
            new java.util.ArrayList<>(groupConfigStore.getAllGroups());
        String currentPlayerName = getCurrentPlayerName();

        if (currentPlayerName != null)
        {
            for (net.runelite.client.plugins.lendingtracker.model.LendingGroup group : allGroups)
            {
	...
	private void showSubmitBorrowRequestDialog()
	{
		...
		gbc.gridx = 1;
		gbc.weightx = 1.0;
		net.runelite.client.plugins.lendingtracker.ui.ItemSearchField itemSearchField =
			new net.runelite.client.plugins.lendingtracker.ui.ItemSearchField(itemManager);
		...
		gbc.gridx = 1;
		gbc.weightx = 1.0;
		net.runelite.client.plugins.lendingtracker.ui.ItemSearchField collateralField =
			new net.runelite.client.plugins.lendingtracker.ui.ItemSearchField(itemManager);
