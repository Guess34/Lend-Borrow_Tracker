package net.runelite.client.plugins.lendingtracker.services.group;
...
public class GroupConfigStore {
    ...
    public boolean joinGroupWithCode(String code, String playerName) {
        ...
        net.runelite.client.plugins.lendingtracker.model.PendingInvite invite = 
            new net.runelite.client.plugins.lendingtracker.model.PendingInvite(
                playerName, 
                code, 
